...
import (
	...
	"github.com/graycarl/hello-go/trace/instrumenter"
	"github.com/graycarl/hello-go/trace/instrumenter/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/graycarl/hello-go/trace", "trace", "Trace")
